...
<body>
    ...
    <div class="card mx-3 px-5">
        <div class="card-header p-5 mx-2">
            <h1>  المعلومات العلمية</h1>
        </div>
        
        <div  class="box p-3 m-1 card-body">
            <form class=" mx-2">
                <div class="form-item border mx-3 px-5 my-3 col-12">
                    <p class="lable-form h3 mb-3 mark">الثانوية</p>
                    <div class="mb-2">
                        <label>المعدل</label>
                    ...
                    <div class="mb-2">
                        <p class="h5">صورة من شهادة الثانوية </p>
                ...
                <div class="form-item border mx-3 px-5 my-3 col-12">
                    <p class="lable-form h3 mb-3 mark">البكالاريوس </p>
                    <div class="mb-2">
                        <label>الكلية</label>
                        <input placeholder=" " type="text">
                    </div>
                    ...
                    <div class="mb-2">
                        <p class="h5">صورة من شهادة البكالاريوس </p>
                        <input placeholder=" " type="file">
                    </div>
                ...
                <div class="form-item border mx-3 px-5 my-3 col-12">
                    <p class="lable-form h3 mb-3 mark"> الماجستير</p>
                    <div class="mb-2">
                        <label>التخصص</label>
                        <input placeholder=" " type="text">
                    </div>
                    ...
                    <div class="mb-2">
                        <p class="h5">صورة من شهادة الماجستير </p>
                        <input placeholder=" " type="file">
                    </div>
                    
                </div>

                <div class="form-item  border mx-3 p-5 pt-1 my-3 col-12">
                    <div class="mb-2">
                        <p class="lable-form h3 mark">  شهادة إضافية (إن وجد) </p>
                        <input placeholder="أضف شهادة أخرى" type="text">
                    </div>
                    <div class="mb-2">
                        <p class="h5">صورة من الشهادة  </p>
                        <input placeholder=" " type="file">
                    </div>
                </div>
            </form>

            <div class="card-footer p-5 mx-2 col-12">
                <button type="submit"  class="btn u-expanded-m bg-primary mx-5 my-2" ><a href="/exp-info"><h4> للعودة  </h4></a></button>
                <button type="submit"  class="btn u-expanded-m bg-primary mx-5 my-2" ><a href="/cou"><h4> تابع لإنشاء سيرتك الذاتية  </h4></a></button>
